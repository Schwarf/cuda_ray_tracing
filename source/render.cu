...
__device__ __host__ Color get_refracted_color(const Ray &incoming_ray, const HitRecord & incoming_hit_record,
...
__device__ __host__ Color get_reflected_color(const Ray &incoming_ray, const IHitRecord & incoming_hit_record, IObjectList **const object_list,
											  ILightSourceEffects **light_source_effects)
{
